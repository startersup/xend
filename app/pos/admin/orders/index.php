    ...
    ?>
        <li>
          <div class="xd-order-card">
            ...
            <div class="xd-orderId xd-space">
              <h5>Action</h5>
              <a class="xd-process-order" data-toggle="modal" data-target="#myModal">Edit</a>
            </div>
          </div>
        </li>
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title xd-poptitle">Order Id: VSP67382</h4>
        </div>
        <div class="modal-body xd-popup-body">
          <h3>Order Items</h3>
          <ul class="xd-order-items">
            <li class="products">Maida Maavu 1kg <input class="xd-rate-box" placeholder="Enter Rate"><a> ❌ </a></li>
            <li class="products">Kadalai Paarupu 200g <input class="xd-rate-box" placeholder="Enter Rate"><a> ❌ </a></li>
            <li class="products">Meera shampoo - 3 Nos <input class="xd-rate-box" placeholder="Enter Rate"><a> ❌ </a></li>
          </ul>
          <div class="xd-grand-total">
            <ul class="xd-order-items">
              <li class="products">Grand Total<input class="xd-rate-box" disabled value="" placeholder=""></li>
              </ul>
          </div>
        </div>
        <div class="modal-footer pD20">
          <a class="xd-cancel">Cancel Order</a>
          <a class="xd-proceed">Proceed Order</a>
        </div>
      </div>
    </div>
  </div>
